...
class StudentExamSeatBookingFragment : Fragment() {
    ...
    private fun saveData() {
        val selected_Itemstud_city = binding.spCity.selectedItem
        val selected_Itemstud_centre = binding.spCenter.selectedItem
        val selected_Itemstud_slot= binding.spSlot.selectedItem
        val stud_city = selected_Itemstud_city?.toString()?.trim() ?: ""
        val stud_centre = selected_Itemstud_centre?.toString()?.trim() ?: ""
        val stud_slot = selected_Itemstud_slot?.toString()?.trim() ?: ""
